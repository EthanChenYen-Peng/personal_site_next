---
title: 'Painless developement setup for React using Parcel (Part 1)'
...
# Painless developement setup for React using Parcel (Part 1)
...
This blog series is about building a setup with a minimum amount of configuration for React using Parcel. Parcel is an opinioned Javascript bundler that brands itself as a _zero config build tool_.

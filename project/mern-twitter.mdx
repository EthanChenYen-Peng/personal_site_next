...
---
## Project URL
<https://mern-twitter.netlify.app>
## Github links
Backend API : <https://github.com/EthanChenYen-Peng/mern_twitter_clone_backend>

Frontend : <https://github.com/EthanChenYen-Peng/mern_twitter_clone_frontend>
## Introduction
